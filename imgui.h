...
public:
    ...
    inline iterator             erase(const_iterator it)        { IM_ASSERT(it >= Data && it < Data+Size); const ptrdiff_t off = it - Data; memmove(Data + off, Data + off 
		, ((size_t)Size - (size_t)off - 1) * sizeof(value_type)); Size--; return Data + off; }
