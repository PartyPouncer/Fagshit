...
void D::SetupFonts( )
{
	...
	I::Surface->SetFontGlyphSet( F::Meme		= I::Surface->Create_Font( ), charenc( "Visitor TT2 -BRK-" ), 30, FW_DONTCARE, NULL, NULL, FONTFLAG_ANTIALIAS );
	I::Surface->SetFontGlyphSet( F::ESP			= I::Surface->Create_Font(), charenc( "Visitor TT2 -BRK-" ), 12, FW_DONTCARE, NULL, NULL, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
	I::Surface->SetFontGlyphSet( F::Watermark	= I::Surface->Create_Font(), charenc( "Dimitri Swank" ), 25, FW_DONTCARE, NULL, NULL, FONTFLAG_OUTLINE | FONTFLAG_ANTIALIAS);
}
