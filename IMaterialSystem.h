...
public:
	const char* GetName() 
	{
		return U::GetVFunc<const char*(__thiscall *)(void*)>(this, 1)(this);
	}

	int GetInt(const char* szKeyName, int nDefault = 0)
	{
		return U::GetVFunc<int(__thiscall *)(void*, const char*, int)>(this, 6)(this, szKeyName, nDefault);
	}

	const char* GetString(const char* szKeyName)
	{
		return U::GetVFunc<const char*(__thiscall *)(void*, const char*, int)>(this, 9)(this, szKeyName, 0);
	}

	void SetString(const char* szKeyName, const char* szValue) 
	{
		return U::GetVFunc<void(__thiscall *)(void*, const char*, const char*)>(this, 16)(this, szKeyName, szValue);
	}

	bool GetBool(const char* keyName, bool defaultValue = false)
	{
		return U::GetVFunc< bool(__thiscall *)(void*, const char*, bool) >(this, 5)(this, keyName, defaultValue);
	}
};
...
public:
	bool FireEventClientSide(IGameEvent* pEvent) {
		return U::GetVFunc<bool(__thiscall *)(void*, IGameEvent*)>(this, 8)(this, pEvent);
	}
};
